...
! Wm Lewis: added 
  ...
  logical post_ssmis16 ! if true, user requested at least on ssmis_f17 channel
  logical post_ssmis18 ! if true, user requested at least on ssmis_f17 channel
...
!     
  ...
  enddo
  post_ssmis17=.false.
  do n = 825, 825+5  ! 825 set in RQSTFLD.f
